...
class _LoanStep1DetailsState extends State<LoanStep1Details>
  ...
  Future<void> _initializeData() async {
    try {
      ...
      /// Fetch policy from provider
      await loan.fetchPolicy();
            ...
            children: [
              ...
              TextFormField(
                ...
                validator: (v) {
                  ...
                  if (parsed < minAmount) {
                    return "Minimum ₹${minAmount.toInt()}";
                  }

                  if (parsed > maxAmount) {
                    return "Maximum ₹${maxAmount.toInt()}";
                  }
              ...
              Text(
                "Allowed range ₹${minAmount.toInt()} - ₹${maxAmount.toInt()}",
